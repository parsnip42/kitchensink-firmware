...
{
    keyHandler.assignLayer(0, Layer("Dflt", {
                { KEY_TILDE,KEY_NON_US_NUM,KEY_1,KEY_2,KEY_3,KEY_4,KEY_5,KEY_NON_US_BS,KeyId::Layer(KeyId::ModifierType::kToggle, 3),KeyId::Layer(KeyId::ModifierType::kToggle, 4),
    ...
    keyHandler.assignLayer(1, Layer("Nav", {
                { },
    ...
    keyHandler.assignLayer(2, Layer("Num", {
                { },
    ...
    keyHandler.assignLayer(3, Layer("Gm0", {
                { },
    ...
    keyHandler.assignLayer(4, Layer("Gm1", {
                { },
                
                { KEY_ESC,0,KEY_Q,KEY_W,KEY_E,KEY_R,KEY_T,KEY_TAB,0,0,
                    0,0,KEY_BACKSPACE,KEY_Y,KEY_U,KEY_I,KEY_O,KEY_P,KEY_LEFT_BRACE,KEY_RIGHT_BRACE },
                
                {0,KeyId::Layer(KeyId::ModifierType::kToggle, 5),KEY_A,KEY_S,KEY_D,KEY_F,KEY_G,0,0,0,
        ...
        keyHandler.assignLayer(5, Layer("Gm2", {
                { },
