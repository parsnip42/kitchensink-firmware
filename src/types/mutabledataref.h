...
public:
    ...
    constexpr MutableDataRef subset(std::size_t start) const;
    constexpr MutableDataRef subset(std::size_t start, std::size_t len) const;
...
inline
constexpr MutableDataRef MutableDataRef::subset(std::size_t start) const
{
    if (start >= size())
    {
...
inline
constexpr MutableDataRef MutableDataRef::subset(std::size_t start, std::size_t len) const
{
    if (start >= size())
    {
        return MutableDataRef();
