...
void init(KeyboardState& keyboardState)
{
...

  {
    ...
    keyboardState.multiSet[0].name = "LShift Toggle";
    ...
    keyboardState.multiSet[1].name = "RShift Toggle";
    ...
    layerStack[0].mapping = { {
            ...
            { { 0, Layer(2), A, S, D, F, G, 0, Macro(14), Macro(15),                        /**/ Macro(25),  Menu(4), 0, H, J, K, L, Semicolon, Enter } },
