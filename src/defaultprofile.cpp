...
void init(KeyboardState& keyboardState)
{
    ...
    keyboardState.multiSet[0].keys[0] = A;
    keyboardState.multiSet[0].keys[1] = B;
    keyboardState.multiSet[0].keys[2] = C;
    
    keyboardState.multiSet[1].keys[0] = X;
    keyboardState.multiSet[1].keys[1] = Y;
    keyboardState.multiSet[1].keys[2] = Z;
    ...
    layerStack[0].mapping = { {
            { { KeyId::Multi(0), KeyId::Multi(1), K1, K2, K3, K4, K5, NonUsBackslash, Macro(10), Macro(11), /**/ Macro(21),  Macro(22), Layer(3), K6, K7, K8, K9, K0, Minus, Equal } },
